...
struct TopPicksView: View {
    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: false, content:  {
            ...
            LazyVGrid(columns: [GridItem(.flexible()),GridItem(.flexible())], alignment: .center, spacing: nil, content: {
...
struct TopPicksView_Previews: PreviewProvider {
    static var previews: some View {
        TopPicksView().environmentObject(UserManager()).environmentObject(AppStateManager())
    }
}
